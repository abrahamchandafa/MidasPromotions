...
import { ChevronDown, Menu, Calendar, MapPin, Clock, Ticket, Music, Globe } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-black text-white" ref={targetRef}>
        ...
        <div className="relative min-h-screen bg-transparent overflow-hidden">
          <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-white">
            ...
            >
              ...
              <span className="block transform hover:scale-105 transition-transform duration-300 text-red-500">
                UNFORGETTABLE
              </span>
              <span className="block transform hover:scale-105 transition-transform duration-300 text-zinc-100">
                LIVE EXPERIENCES
      ...
      <motion.section
        ...
        viewport={{ once: true }}
      >
        <h2 className="text-4xl font-bold mb-12 text-center text-red-500">Upcoming Events</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {[
            ...
            <motion.div
              ...
              className="relative"
            >
              <Card className="bg-zinc-800 border-2 border-red-500 overflow-hidden h-full shadow-lg shadow-red-500/20">
                <CardContent className="p-0 flex flex-col h-full">
                  <div className="relative h-48">
                    <Image src={event.image || "/placeholder.svg"} alt={event.title} fill className="object-cover" />
                    <div className="absolute top-2 right-2">
                      <Badge className="bg-red-500 text-black font-bold">{event.genre}</Badge>
                    </div>
                  </div>
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <div className="flex items-center justify-between mt-auto">
                      ...
                      <Button className="bg-red-500 text-black hover:bg-yellow-600">Get Tickets</Button>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            >
              <Card className="bg-zinc-800 border-none overflow-hidden h-full">
                <CardContent className="p-0 flex flex-col h-full">
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    <h3 className="text-xl font-bold mb-2 text-red-500">{event.title}</h3>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold mb-12 text-center text-red-500">Our Impact</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                >
                  <stat.icon className="w-12 h-12 text-red-500" />
                </motion.div>
                <motion.h3
      ...
      <footer className="bg-zinc-900 py-12 px-4 md:px-8">
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-8">
          <div>
            <h4 className="font-bold mb-4 text-red-500">MIDAS PROMOTIONS</h4>
